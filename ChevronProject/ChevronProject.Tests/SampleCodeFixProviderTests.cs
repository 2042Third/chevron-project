...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<ChevronProject.SampleSyntaxAnalyzer,
        ChevronProject.SampleCodeFixProvider>;

namespace ChevronProject.Tests;
